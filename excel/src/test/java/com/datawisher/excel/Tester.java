package com.datawisher.excel;

import com.alibaba.excel.EasyExcel;
import com.alibaba.excel.ExcelReader;
import com.alibaba.excel.read.metadata.ReadSheet;
import com.alibaba.fastjson.JSON;
import com.datawisher.excel.easyexcel.listener.ConverterDataListener;
import com.datawisher.excel.easyexcel.listener.DemoDataListener;
import com.datawisher.excel.easyexcel.listener.DemoHeadDataListener;
import com.datawisher.excel.easyexcel.listener.IndexOrNameDataListener;
import com.datawisher.excel.easyexcel.model.ConverterData;
import com.datawisher.excel.easyexcel.model.DemoData;
import com.datawisher.excel.easyexcel.model.IndexOrNameData;
import com.datawisher.excel.easyexcel.util.TestFileUtil;
...
public class Tester {
    ...
    public void simpleRead() {
        // 写法1：
        String fileName = TestFileUtil.getPath() + "files" + File.separator + "excel示例.xlsx";
        // 这里 需要指定读用哪个class去读，然后读取第一个sheet 文件流会自动关闭
        EasyExcel.read(fileName, DemoData.class, new DemoDataListener()).sheet().doRead();

        // 写法2：
        fileName = TestFileUtil.getPath() + "files" + File.separator + "excel示例.xlsx";
